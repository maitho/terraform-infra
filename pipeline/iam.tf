resource "aws_iam_role" "tf-codepipeline-role" {
  name               = "tf-codepipeline-role-${var.CodeRepoName}"
...
resource "aws_iam_policy" "tf-cicd-pipeline-policy" {
  name        = "tf-cicd-pipeline-policy-${var.CodeRepoName}"
  path        = "/"
  description = "Pipeline policy for ${var.CodeRepoName}"
...
resource "aws_iam_role" "tf-codebuild-role" {
  name = "tf-codebuild-role-${var.CodeRepoName}"
...
resource "aws_iam_policy" "tf-cicd-build-policy" {
  name        = "tf-cicd-build-policy-${var.CodeRepoName}"
  path        = "/"
  description = "Codebuild policy for ${var.CodeRepoName}"
